...
public class EventsManager extends DHXEventsManager {
    ...
    public Iterable getEvents() {
        ...
        try {
            ...
            String query = "SELECT event_id, event_name, start_date, end_date FROM events WHERE ID_PERSONAL ="+ lc.getId();
    ...
    public DHXStatus saveEvent(DHXEv event, DHXStatus status) {
        ...
        try {
            ...
            if (status == DHXStatus.UPDATE) {
                query = "UPDATE events SET event_name=?, start_date=?, end_date=? , ID_PERSONAL =? WHERE event_id=?";
                ...
                query = "INSERT INTO events (event_id, event_name, start_date, end_date, ID_PERSONAL) VALUES (null, ?, ?, ?,?)";
                ps = conn.prepareStatement(query, Statement.RETURN_GENERATED_KEYS);
                ps.setString(1, event.getText());
                ps.setString(2, start_date);
                ps.setString(3, end_date);
